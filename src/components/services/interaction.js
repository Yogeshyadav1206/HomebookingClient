...
export const gethomelist = async () => {
  try {
    const response = await fetch("http://localhost:4003/homelist", {
      credentials: "include",
    });
...
export const getfavlist = async () => {
  try {
    const response = await fetch("http://localhost:4003/favouritelist", {
      credentials: "include",
    });
...
export const getBookings = async () => {
  try {
    const response = await fetch("http://localhost:4003/booking", {
      credentials: "include",
    });
...
export const gethomedetails = async (homeId) => {
  ...
  try {
    const response = await fetch(`http://localhost:4003/homelist/${homeId}`, {
      credentials: "include",
    });
...
export const addToFav = async (homeId) => {
  ...
  try {
    const response = await fetch("http://localhost:4003/fav", {
      method: "POST",
      headers: {
...
export const removeFromFav = async (homeId) => {
  ...
  try {
    const response = await fetch("http://localhost:4003/fav-remove", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
export const getaddHome = async () => {
  try {
    const response = await fetch("http://localhost:4003/host/add-home", {
      credentials: "include",
    });
...
export const getEditHome = async (homeId) => {
  try {
    const response = await fetch(`http://localhost:4003/host/editHome/${homeId}`, {
      credentials: "include",
    });
...
export const getHostHomes = async () => {
  try {
    const response = await fetch(`http://localhost:4003/host/hosthomelist`, {
      credentials: "include",
    });
...
export const removeFromHost = async (homeId) => {
  ...
  try {
    const response = await fetch("http://localhost:4003/host/removefromhost", {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
